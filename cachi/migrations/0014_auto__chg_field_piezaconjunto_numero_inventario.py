...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PiezaConjunto.numero_inventario'
        db.alter_column(u'cachi_piezaconjunto', 'numero_inventario', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PiezaConjunto.numero_inventario'
        db.alter_column(u'cachi_piezaconjunto', 'numero_inventario', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
    ...
    models = {
        ...
        u'cachi.ubicaciongeografica': {
            ...
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'padre': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'hijos'", 'null': 'True', 'to': u"orm['cachi.UbicacionGeografica']"})
        },
