...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UbicacionGeografica.nivel'
        db.add_column(u'cachi_ubicaciongeografica', 'nivel',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UbicacionGeografica.nivel'
        db.delete_column(u'cachi_ubicaciongeografica', 'nivel')
