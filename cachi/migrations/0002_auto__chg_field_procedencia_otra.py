...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Procedencia.otra'
        db.alter_column(u'cachi_procedencia', 'otra', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Procedencia.otra'
        db.alter_column(u'cachi_procedencia', 'otra', self.gf('django.db.models.fields.CharField')(default=1, max_length=64))
