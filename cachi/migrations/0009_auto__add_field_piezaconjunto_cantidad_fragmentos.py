...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PiezaConjunto.cantidad_fragmentos'
        db.add_column(u'cachi_piezaconjunto', 'cantidad_fragmentos',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PiezaConjunto.cantidad_fragmentos'
        db.delete_column(u'cachi_piezaconjunto', 'cantidad_fragmentos')
