...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PiezaConjunto.numero_inventario'
        db.add_column(u'cachi_piezaconjunto', 'numero_inventario',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Fragmento.numero_inventario'
        db.delete_column(u'cachi_fragmento', 'numero_inventario')


    def backwards(self, orm):
        # Deleting field 'PiezaConjunto.numero_inventario'
        db.delete_column(u'cachi_piezaconjunto', 'numero_inventario')

        # Adding field 'Fragmento.numero_inventario'
        db.add_column(u'cachi_fragmento', 'numero_inventario',
