...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FichaTecnica.inscripciones_marcas'
        db.alter_column(u'cachi_fichatecnica', 'inscripciones_marcas', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.otras_caracteristicas_distintivas'
        db.alter_column(u'cachi_fichatecnica', 'otras_caracteristicas_distintivas', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.desperfectos'
        db.alter_column(u'cachi_fichatecnica', 'desperfectos', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.tratamiento'
        db.alter_column(u'cachi_fichatecnica', 'tratamiento', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.desperfectos_fabricacion'
        db.alter_column(u'cachi_fichatecnica', 'desperfectos_fabricacion', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.observacion'
        db.alter_column(u'cachi_fichatecnica', 'observacion', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.reparaciones'
        db.alter_column(u'cachi_fichatecnica', 'reparaciones', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FichaTecnica.decoracion'
        db.alter_column(u'cachi_fichatecnica', 'decoracion', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PiezaConjunto.condicion_hallazgo'
        db.alter_column(u'cachi_piezaconjunto', 'condicion_hallazgo', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PiezaConjunto.tecnica_manufactura'
        db.alter_column(u'cachi_piezaconjunto', 'tecnica_manufactura', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'FichaTecnica.inscripciones_marcas'
        db.alter_column(u'cachi_fichatecnica', 'inscripciones_marcas', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.otras_caracteristicas_distintivas'
        db.alter_column(u'cachi_fichatecnica', 'otras_caracteristicas_distintivas', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.desperfectos'
        db.alter_column(u'cachi_fichatecnica', 'desperfectos', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.tratamiento'
        db.alter_column(u'cachi_fichatecnica', 'tratamiento', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.desperfectos_fabricacion'
        db.alter_column(u'cachi_fichatecnica', 'desperfectos_fabricacion', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.observacion'
        db.alter_column(u'cachi_fichatecnica', 'observacion', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.reparaciones'
        db.alter_column(u'cachi_fichatecnica', 'reparaciones', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FichaTecnica.decoracion'
        db.alter_column(u'cachi_fichatecnica', 'decoracion', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PiezaConjunto.condicion_hallazgo'
        db.alter_column(u'cachi_piezaconjunto', 'condicion_hallazgo', self.gf('django.db.models.fields.TextField')(default=1, max_length=128))

        # Changing field 'PiezaConjunto.tecnica_manufactura'
        db.alter_column(u'cachi_piezaconjunto', 'tecnica_manufactura', self.gf('django.db.models.fields.TextField')(default=1, max_length=128))
