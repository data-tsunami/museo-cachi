...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fragmento.ultima_version'
        db.alter_column(u'cachi_fragmento', 'ultima_version_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cachi.FichaTecnica']))

    def backwards(self, orm):

        # Changing field 'Fragmento.ultima_version'
        db.alter_column(u'cachi_fragmento', 'ultima_version_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cachi.FichaTecnica']))
    ...
    models = {
        ...
        u'cachi.fragmento': {
            ...
            'pieza_conjunto': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fragmento'", 'to': u"orm['cachi.PiezaConjunto']"}),
