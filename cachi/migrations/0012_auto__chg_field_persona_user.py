...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.user'
        db.alter_column(u'cachi_persona', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Persona.user'
        db.alter_column(u'cachi_persona', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True))
