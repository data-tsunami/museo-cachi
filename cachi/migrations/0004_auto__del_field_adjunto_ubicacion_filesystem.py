...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Adjunto.ubicacion_filesystem'
        db.delete_column(u'cachi_adjunto', 'ubicacion_filesystem')


    def backwards(self, orm):
        # Adding field 'Adjunto.ubicacion_filesystem'
        db.add_column(u'cachi_adjunto', 'ubicacion_filesystem',
