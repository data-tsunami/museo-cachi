...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FichaTecnica.diagnostico_estado'
        db.add_column(u'cachi_fichatecnica', 'diagnostico_estado',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FichaTecnica.diagnostico_estado'
        db.delete_column(u'cachi_fichatecnica', 'diagnostico_estado')
    ...
    models = {
        ...
        u'cachi.procedencia': {
            ...
            'pieza_conjunto': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'procedencia'", 'to': u"orm['cachi.PiezaConjunto']"}),
