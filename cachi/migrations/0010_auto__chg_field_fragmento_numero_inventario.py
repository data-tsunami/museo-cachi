...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fragmento.numero_inventario'
        db.alter_column(u'cachi_fragmento', 'numero_inventario', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Fragmento.numero_inventario'
        raise RuntimeError("Cannot reverse this migration. 'Fragmento.numero_inventario' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Fragmento.numero_inventario'
        db.alter_column(u'cachi_fragmento', 'numero_inventario', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'cachi.fragmento': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numero_inventario': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'cachi.piezaconjunto': {
            ...
            'cantidad_fragmentos': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
