...
;(function($) {
        ...
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                ...
                if (row.is('TR')) {
                    ...
                    row.children(':last').append('<a title="Eliminar" class="btn btn-danger btn-small ' + options.deleteCssClass +'" href="javascript:void(0)"><span class="glyphicon glyphicon-remove"></span></a>');
                } else if (row.is('UL') || row.is('OL')) {
                    // If they're laid out as an ordered/unordered list,
                    // insert an <li> after the last list item:
                    row.append('<li><a title="Eliminar" class="btn btn-danger btn-small ' + options.deleteCssClass + '" href="javascript:void(0)"><span class="glyphicon glyphicon-remove"></span></a></li>');
                } else {
                    // Otherwise, just insert the remove button as the
                    // last child element of the form's container:
                    row.append('<a title="Eliminar" class="btn btn-danger btn-small ' + options.deleteCssClass + '" href="javascript:void(0)"><span class="glyphicon glyphicon-remove"></span></a>');
                }
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label').each(function() {
                    ...
                    if (elem.is('input:checkbox') || elem.is('input:radio')) {
                        ...
                        elem.attr('selectedIndex', '-1').find("option:selected").removeAttr("selected");
                    } else {
                        elem.val('');
                    }
                });
    ...
    $.fn.formset.defaults = {
        ...
        added: (function(row){
            /*
            Remueve el boton de Prácticas en la app obrasocial.
            */
            row.find('.practicas').remove();
